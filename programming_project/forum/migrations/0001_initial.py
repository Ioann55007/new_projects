    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default='media/no_image.jpg', upload_to='', verbose_name='forum.User')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(default=uuid.uuid1, max_length=130, unique=True)),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='topic_bookmark', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Topic',
